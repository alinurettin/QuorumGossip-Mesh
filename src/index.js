// QuorumGossip-Mesh - Production HTTP Server & OpenMetrics Exporter
...
const PORT = parseInt(process.env.PORT, 10) || 6040;
...
if (require.main === module) {
  startServer(PORT, () => {
    console.log('⚡ QuorumGossip-Mesh active at http://localhost:' + PORT);
  });
}
